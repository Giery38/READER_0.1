...
namespace READER_0._1.Command.Settings.SettingsExel
{
    class AddSearchingFormatCommand : CommandBase
    {
        ...
        public AddSearchingFormatCommand(SettingsExelViewModel settingsExelViewModel, ExelSettings settings)
        {
        ...
        {
            settingsExelViewModel.SearchingFormats.Add(new StringContainer("", settings.ExelSettingsSearchFiles.FormatsSearch));
            settings.ExelSettingsSearchFiles.FormatsSearch.Add("");
        }
    }
}
